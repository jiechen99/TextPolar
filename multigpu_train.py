...
def main(argv=None):
    ...
    input_sc_weight_maps = tf.placeholder(tf.float32, shape=[None, None, None, 1], name='input_sc_weight_maps')
    ...
    input_sc_weight_maps_split = tf.split(input_sc_weight_maps, len(gpus))
    ...
    for i, gpu_id in enumerate(gpus):
        with tf.device('/gpu:%d' % gpu_id):
            with tf.name_scope('model_%d' % gpu_id) as scope:
                ...
                iswms = input_sc_weight_maps_split[i]
